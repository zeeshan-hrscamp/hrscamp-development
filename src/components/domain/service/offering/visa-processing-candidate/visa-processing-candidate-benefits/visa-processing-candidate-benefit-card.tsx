...
const VisaProcessingCandidateServiceBenefitCard = () => {
  const data = useStaticQuery(graphql`
    query VisaProcessingCandidateServiceBenefitCardQuery {
      allMarkdownRemark(
        filter: {
          frontmatter: {
            domain: { eq: "service" }
            domain_section: { eq: "benefit" }
            service_title: { eq: "Visa Processing for Candidates" }
          }
        }
...
export default VisaProcessingCandidateServiceBenefitCard;
