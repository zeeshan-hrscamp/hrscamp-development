...
const JobPlacementServiceBenefitCard = () => {
  const data = useStaticQuery(graphql`
    query JobPlacementServiceBenefitCardQuery {
      allMarkdownRemark(
        filter: {
          frontmatter: {
            domain: { eq: "service" }
            domain_section: { eq: "benefit" }
            service_title: { eq: "Job Placement" }
          }
        }
...
export default JobPlacementServiceBenefitCard;
