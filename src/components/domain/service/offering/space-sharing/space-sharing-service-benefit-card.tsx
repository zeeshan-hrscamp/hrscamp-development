...
const SpaceSharingServiceBenefitCard = () => {
  const data = useStaticQuery(graphql`
    query SpaceSharingServiceBenefitCardQuery {
      allMarkdownRemark(
        filter: {
          frontmatter: {
            domain: { eq: "service" }
            domain_section: { eq: "benefit" }
            service_title: { eq: "Space Sharing" }
          }
        }
...
export default SpaceSharingServiceBenefitCard;
