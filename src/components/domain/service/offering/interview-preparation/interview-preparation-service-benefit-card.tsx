...
const InterviewPreparationServiceBenefitCard = () => {
  const data = useStaticQuery(graphql`
    query InterviewPreparationServiceBenefitCardQuery {
      allMarkdownRemark(
        filter: {
          frontmatter: {
            domain: { eq: "service" }
            domain_section: { eq: "benefit" }
            service_title: { eq: "Interview Preparation" }
          }
        }
...
export default InterviewPreparationServiceBenefitCard;
