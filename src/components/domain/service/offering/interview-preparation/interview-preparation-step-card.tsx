...
const InterviewPreparationStepCard = () => {
  const data = useStaticQuery(graphql`
    query InterviewPreparationStepCardQuery {
      allMarkdownRemark(
        filter: {
          frontmatter: {
            domain: { eq: "process" }
            domain_section: { eq: "step" }
            process_title: { eq: "Interview Preparation" }
          }
        }
...
export default InterviewPreparationStepCard;
