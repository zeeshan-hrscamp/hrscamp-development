...
const AttestationServiceBenefitCard = () => {
  const data = useStaticQuery(graphql`
    query AttestationServiceBenefitCardQuery {
      allMarkdownRemark(
        filter: {
          frontmatter: {
            domain: { eq: "service" }
            domain_section: { eq: "benefit" }
            service_title: { eq: "Document Attestation and Verification of Antecedents" }
          }
        }
...
export default AttestationServiceBenefitCard;
