...
const VisaProcessingClientStepCard = () => {
  const data = useStaticQuery(graphql`
    query VisaProcessingClientStepCardQuery {
      allMarkdownRemark(
        filter: {
          frontmatter: {
            domain: { eq: "process" }
            domain_section: { eq: "step" }
            process_title: { eq: "Visa Processing for Clients" }
          }
        }
...
export default VisaProcessingClientStepCard;
