...
const VisaProcessingClientServiceBenefitCard = () => {
  const data = useStaticQuery(graphql`
    query VisaProcessingClientServiceBenefitCardQuery {
      allMarkdownRemark(
        filter: {
          frontmatter: {
            domain: { eq: "service" }
            domain_section: { eq: "benefit" }
            service_title: { eq: "Visa Processing for Clients" }
          }
        }
...
export default VisaProcessingClientServiceBenefitCard;
